...
<body class="sanckbg mode_webapp">
	...
	<div id="member-container" <?php if(($_GET['tid']== 2)): ?>style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
		...
		<div class="div_header">
			...
			<span class="header_right">
				...
				<div><span>族长：<?php if($users["member"] == 1): ?>是<?php else: ?>否(<a style='color:red' href='./index.php?g=App&m=Index&a=index'>点击链接成为族长</a>)<?php endif; ?></span></div>
				...
				<div><span>会员ID：<?php echo ($users["id"]); ?>  <?php if($users["member"] == 1): if(isset($dongjia_time) && !empty($dongjia_time)){echo "<span>族长剩余时间:$dongjia_time天</span>";} endif; ?></span></div>
    ...
    <div id="ticket-container" <?php if(($_GET['tid']== 3)): ?>style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
    ...
    <div id="user-container" <?php if(($_GET['tid']== 1)): ?>style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
	...
	<div class="footermenu">
		<ul>
			<li ><a href="./index.php?g=App&m=Index&a=index_info"> <img src="../Public/Static/images/21.png">
					<p>首页</p>
			</a></li>
			<li id="user"><a href="javascript:void(0);" <?php if(($_GET['tid']== 1)): ?>class="active"<?php endif; ?>> <img src="../Public/Static/images/22.png">
					<p>我的订单</p>
			</a></li>
			<li id="member"><a href="javascript:void(0);" <?php if(($_GET['tid']== 2)): ?>class="active"<?php endif; ?>> <img src="../Public/Static/images/23.png">
					<p>个人中心</p>
			</a></li>
			<li id="ticket"><a href="javascript:void(0);" <?php if(($_GET['tid']== 3)): ?>class="active"<?php endif; ?>> <img src="../Public/Static/images/24.png">
					<p>活动中心</p>
			</a></li>
	...
	<script>
            ...
            <?php if(($_GET['tid']== 1)): ?>user();<?php endif; ?>
